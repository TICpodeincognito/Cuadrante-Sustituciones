document.addEventListener('DOMContentLoaded', () => {
    const app = {
        ...
        loadData() {
            const clavesPosibles = ['datosSustituciones_v51M9_corr2', 'datosSustituciones_v51M9', 'datosSustituciones_v51', 'datosSustituciones_v5', 'datosSustituciones'];
        ...
        cargarDatosIniciales() {
            fetch('horario_maestros_2425.json')
                ...
                .then(datosDesdeJSON => {
                    ...
                    this.procesarDatosCargados();
                    this.saveData(); // Guardar estos datos iniciales en localStorage
                })
                .catch(error => {
                    console.error('Error al cargar datos iniciales desde JSON:', error);
                    // Si falla la carga del JSON, inicializa con datos vacíos
